...
if theme == 'dark' then
    ...
    DTTransparency = 0.6
     ...
     -- local UIGradientTitle=Instance.new("UIGradient")
      ...
      Main.Size = UDim2.new(0, 510, 0, 345)
      Main.ZIndex = 1
      Main.Active = true
      Main.Draggable = true
      ...
      function window.Tab(window, name, icon)
        ...
        function section:Label(text)
          ...
          function section.Toggle(section, text, flag, enabled, callback)
            ...
            ToggleModule.BackgroundColor3 = Color3.fromRGB(255, 97, 0)
            ...
            ToggleBtn.Text = "   " .. text
            ToggleBtn.TextColor3 = Color3.fromRGB(255, 97, 0)
          ...
          function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            SliderModule.BackgroundColor3 = Color3.fromRGB(255, 97, 0)
            ...
            SliderBack.TextColor3 = Color3.fromRGB(255, 97, 0)
            ...
            MinSlider.BackgroundColor3 = Color3.fromRGB(255, 97, 0)
          ...
          function section.Dropdown(section, text, flag, options, callback)
            ...
            funcs.AddOption = function(self, option)
              ...
              Option.Text = option
              Option.TextColor3 = Color3.fromRGB(255, 97, 0)
