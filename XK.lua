...
print("索引开启反挂机")
		...
		game:GetService("Players").LocalPlayer.Idled:connect(function()
		   ...
		   vu:Button2Up(Vector2.new(0,0),workspace.CurrentCamera.CFrame)
                ...
                wait(1)
library.prompt('XK脚本中心', '欢迎使用XK脚本中心', 10)
...
local Window = OrionLib:MakeWindow({IntroText = "XK脚本中心V5",Name = " 丨XK脚本中心丨V5 执行器:" ..identifyexecutor() , HidePremium = false, SaveConfig = true, ConfigFolder = ""})
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
